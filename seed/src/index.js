        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                generatePosts = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var postString, postTemplate, posts, i, post, author;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, generatePosts()];
            case 3:
                posts = _a.sent();
                console.log('writing posts');
                return [4 /*yield*/, fs.writeFileSync(__dirname + "/../mongodb/posts.json", JSON.stringify(posts), 'utf-8')];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
